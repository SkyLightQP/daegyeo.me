    ...
    <>
      ...
      <Content>
        ...
        <ContentBlock title="프로젝트">
          <ProjectTitle>AskQ</ProjectTitle>
          <ProjectBody>
            익명 질문 서비스입니다. <br />
            <b>Vue, Firebase</b>를 사용했습니다. <br />
            <DirectLink href="https://ask.skylightqp.kr">서비스 바로가기</DirectLink>
          </ProjectBody>
          <br />

          <ProjectTitle>끄투닷컴</ProjectTitle>
          <ProjectBody>
          ...
          <ProjectTitle>Kronos</ProjectTitle>
          <ProjectBody>
          ...
          <ProjectTitle>수정과</ProjectTitle>
          <ProjectBody>
            교내 인트라넷 서비스입니다. <br />
            시간표 확인, 방과 후 신청, 교내 사업을 온라인으로 진행할 수 있습니다. <br />
        ...
        <ContentBlock title="수상">
          <ProjectTitle>제3회 장애인식개선콘텐츠공모전 최우수상</ProjectTitle>
          <ProjectBody>영상 분야에 참여했습니다.</ProjectBody>
          <br />
          <ProjectTitle>Hello20Thon 장려상</ProjectTitle>
